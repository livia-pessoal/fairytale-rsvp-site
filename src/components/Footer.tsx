        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          ...
          <div className="text-center md:text-left">
            <div className="flex items-center justify-center md:justify-start gap-2 sm:gap-3 mb-4">
              ...
              <h3 className="text-2xl sm:text-3xl font-script text-gradient">Giovana & Bruno</h3>
            </div>
          ...
          <div className="text-center">
            <h3 className="text-lg sm:text-xl font-cardo font-bold text-primary mb-4">Detalhes do Casamento</h3>
          ...
          <div className="text-center md:text-right">
            <h3 className="text-lg sm:text-xl font-cardo font-bold text-primary mb-4">Contato</h3>
            <div className="space-y-3">
